...
export class DiceNotation {
    ...
    static mergeNotation(prevNotation, newNotation) {
        ...
        const newNotationVectors = Object.assign(Object.assign({}, prevNotation), { constant: prevNotation.constant + newNotation.constant, notation: prevNotation.notation + "+" + newNotation.notation, set: [...prevNotation.set, ...newNotation.set], totalDice: prevNotation.vectors.length + newNotation.vectors.length, vectors: [...prevNotation.vectors, ...newNotation.vectors] });
